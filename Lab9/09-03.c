...
/**
 * Синхронизация:
 * Отец выполняет операцию D(1), чтобы не дать ребенку помешаем ему прочитать сообщение и написать новое.
 * А ребенок выполняет при новой итерации цикла операцию Z, то есть на проверку равенста нулю, а потом увеличивает
 * Значение семафора на 2. Чтобы вновь стало 0, нужно, чтобы отец зашёл в цикл и вышел, то есть два раза
 * происходит декрементирование.
 */
